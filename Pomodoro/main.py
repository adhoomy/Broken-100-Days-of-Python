...
start_button = Button(text="Start", font=(FONT_NAME, 10, "bold"), fg="black")
start_button.grid(column=0, row=2)

reset_button = Button(text="Reset", font=(FONT_NAME, 10, "bold"), fg="black")
reset_button.grid(column=2, row=2)

checks_shown = Label(text="✓", font=(FONT_NAME, 15, "bold"), fg=GREEN, bg=YELLOW)
